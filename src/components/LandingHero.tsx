        ...
        <div className="relative rounded-2xl overflow-hidden">
          ...
          <div className="relative z-10 p-8 md:p-10">
            <div className="max-w-3xl mx-auto text-center space-y-6">
              ...
              >
                {["100% Free", "No Signup", "No Watermarks", "Instant Results"].map((label, i) => (
                  <div key={i} className="flex items-center justify-start gap-2 py-1">
                    <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[#6366F1]/10 text-[#6366F1] text-[10px] font-bold">✓</span>
              ...
              >
                <div className="p-1">
                  ...
                  >
                    <input {...getInputProps({ name: 'imageUpload' })} />
                    <div className="flex flex-col items-center text-center">
                      ...
                      <div className="flex flex-wrap justify-center items-center gap-3">
                        {["JPG", "PNG", "JPEG"].map((format) => (
                          <span key={format} className="px-2 py-1 bg-gray-100 text-gray-600 text-xs rounded-md font-medium">{format}</span>
                        ))}
